...
> [!IMPORTANT]
> **Requires Signal K server v2.31 or newer.** Major performance upgrades and features in v2.31 that are now required for this plugin to work. Plugin version 2.12.0 and earlier will continue to work in older versions of SK Server.
